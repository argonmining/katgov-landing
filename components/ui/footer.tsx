      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="md:flex md:items-center md:justify-between pb-4 md:pb-8">
          ...
          <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
            ...
            <li className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
              <a
                className="flex justify-center items-center text-indigo-500 hover:text-slate-300 transition duration-150 ease-in-out"
                href="https://github.com/argonmining/kat-gov"
                aria-label="Github"
              >
                <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="text-sm text-slate-600">
            <a className="text-slate-500 hover:text-slate-300 transition duration-150 ease-in-out" href="https://NachoWyborski.xyz">Built with  ❤️ by the Nacho the Kat Community</a>
          </div>
        </div>
      </div>
    </footer>
